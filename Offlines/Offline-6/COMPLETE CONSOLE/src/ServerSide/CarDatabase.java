...
//                System.out.println();
    ...
    public int Login(HashMap < String , String> hm, BufferedReader in, PrintWriter out) {
        String UID;
        String Pass;
        try
        {
    ...
    public int runMainMenu(BufferedReader in, PrintWriter out, int user)
    {
        int mainMenu;
...
//        out.println("(8) Exit System");
        if(user == 1){
            out.println("(1) View All Cars");
            out.println("(2) Show Quantities");
            out.println("(3) Add Car");
            out.println("(4) Edit Car");
            out.println("(5) Delete Cars");
            out.println("(6) Exit System");
        }
        else if (user == 2){
            out.println("(1) View All Cars");
            out.println("(2) Show Quantities");
            out.println("(3) Search Cars by Registration Number");
            out.println("(4) Search Cars by Make and Model");
            out.println("(5) Buy Car");
            out.println("(6) Exit System");
        }
    ...
    public int runRegSearch(BufferedReader in, PrintWriter out){
    ...
    public int runMakeSearch(BufferedReader in, PrintWriter out){
