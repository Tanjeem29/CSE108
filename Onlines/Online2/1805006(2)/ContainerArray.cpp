...
public:
    ...
    setItemAt (Container cont, int index)
    {
        if(index >=allocatedSize)
        {
        ...
        {
            if(cont.getStoredType()== INTEGER)
                arrayOfContainers[index].setItem(*(int *)cont.getItem());
            else if(cont.getStoredType() == INT_ARRAY)
                arrayOfContainers[index].setItem((int *)cont.getItem(), cont.getFirstDim());
            else if(cont.getStoredType() == INT_MATRIX)
                arrayOfContainers[index].setItem((int**)cont.getItem(), cont.getFirstDim(), cont.getSecondDim());
        }
    }
