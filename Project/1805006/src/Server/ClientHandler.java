    ...
    public void run() {
        try {
            ...
            while (true) {
                ...
                if (s[0].equalsIgnoreCase("closeProgram")) {
...
//
                ...
                if (s[0].equalsIgnoreCase("buyCar")){
                    ...
                    try{
                        ...
                        out.println("Registration ID CANNOT BE EMPTY");
                        //out.println("$$End");
                    }
                    out.println("$$End");
                }
                ...
                if (s[0].equalsIgnoreCase("editCar")){
                    ...
                    try{
                        ...
                        out.println("Error! Please search Registration number.");
                    }
                    out.println("$$End");
                }
                ...
                if (s[0].equalsIgnoreCase("addCar")){
                    ...
                    try{
                        ...
                        out.println("Error! Please fill out required fields.");
                    }
                    out.println("$$End");
                }
            }
